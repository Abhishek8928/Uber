...
## Overview
This document provides details on the API endpoints for user registration and login, including the required data fields, their constraints, and example requests and responses.
...
#### Description
This endpoint allows a new captain to register by providing their personal information. It validates the input fields and returns a token upon successful registration.
